...
const Masonry: React.FC<MasonryProps> = ({
  ...
  useLayoutEffect(() => {
    ...
    grid.forEach((item, index) => {
      ...
      if (!hasMounted.current) {
        if (animate) {
          ...
          // No entrance animation — place items directly
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [grid, imagesReady, stagger, animateFrom, blurToFocus, duration, ease, animate]);
  ...
  // Self-size the container so it works inside normal page flow
