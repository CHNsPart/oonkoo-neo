...
export default function Hero() {
  ...
  return (
    <div className="w-full h-full px-4 sm:px-6 lg:px-8 pb-8 pt-20 sm:pt-24 z-[1]">
      <div className="h-full max-w-[1400px] mx-auto space-y-4 relative">
        {/* Main Title Section - Full Width */}
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="w-full bg-black/40 backdrop-blur-sm p-6 sm:p-8 rounded-3xl border border-white/10 flex flex-col justify-center"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <motion.div 
            ...
            className="w-full h-full min-h-[200px] relative bg-gradient-to-br from-brand-primary/20 to-black/40 backdrop-blur-sm p-6 rounded-3xl border border-white/10 overflow-hidden flex flex-col justify-between"
          >
          ...
          <motion.div 
            ...
            className="w-full h-full min-h-[200px] md:col-span-2 relative bg-black/40 backdrop-blur-sm rounded-3xl border border-white/10 overflow-hidden group"
          >
            <video 
              autoPlay 
              loop 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <motion.div 
            ...
            className="w-full h-full min-h-[150px] bg-black/40 backdrop-blur-sm p-6 sm:p-8 rounded-3xl border border-white/10 flex items-center"
          >
          ...
          <motion.div 
            ...
            className="w-full h-full min-h-[150px] bg-gradient-to-r from-brand-primary/20 to-black/40 backdrop-blur-sm p-6 sm:p-8 rounded-3xl border border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4"
          >
            <div className="text-center sm:text-left">
              <h3 className="text-xl font-semibold mb-2">Ready to start?</h3>
              <p className="text-white/70">{"Let's create something extraordinary together"}</p>
            </div>
            <div onClick={() => setIsModalOpen(true)} className="flex-shrink-0">
              <HoverBorderGradient className="w-full sm:w-auto">
                <span className="flex justify-center whitespace-nowrap">Contact Us</span>
              </HoverBorderGradient>
            </div>
          </motion.div>
        </div>
